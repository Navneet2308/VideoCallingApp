...
private RecyclerView notification_list;
    private DatabaseReference firendRequestRef,contacsRef,userRef;
    ...
    protected void onStart() {
       ...
       FirebaseRecyclerOptions options= new FirebaseRecyclerOptions.Builder<Contacts>()
                .setQuery(firendRequestRef.child(currentUserId),Contacts.class)
                .build();
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                holder.accept.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        contacsRef.child(currentUserId).child(listUserId)
                                                                ...
                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    ...
                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                        if (task.isSuccessful())
                                                                        {
                                                                            ...
                                                                            contacsRef.child(listUserId).child(currentUserId)
                                                                                    .child("Contact").setValue("Saved")
                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                        @Override
                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                            if (task.isSuccessful())
                                                                                            {
                                                                                                firendRequestRef.child(currentUserId).child(listUserId)
                                                                                                        .removeValue()
                                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                            @Override
                                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                                                if (task.isSuccessful())
                                                                                                                {
                                                                                                                    firendRequestRef.child(listUserId).child(currentUserId)
                                                                                                                            .removeValue()
                                                                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                                @Override
                                                                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                    if (task.isSuccessful())
                                                                                                                                    {
                                                                                                                                        Toast.makeText(NotificationActivity.this, "New Contact Save", Toast.LENGTH_SHORT).show();
    ...
    public static class  NotificationViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public NotificationViewHolder(@NonNull View itemView) {
            ...
            reject=itemView.findViewById(R.id.request_decline_btn);
